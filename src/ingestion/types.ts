export type NormalizedLead = { externalId: string; channel?: string; utmSource?: string; utmCampaign?: string; currentStage: string; valueCents?: number; lostReason?: string | null; identityKey?: string | null; createdAt: Date; updatedAt: Date }
