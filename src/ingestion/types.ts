export type NormalizedLead = { externalId: string; name?: string | null; channel?: string; utmSource?: string; utmCampaign?: string; creative?: string | null; currentStage: string; valueCents?: number; lostReason?: string | null; identityKey?: string | null; createdAt: Date; updatedAt: Date }
